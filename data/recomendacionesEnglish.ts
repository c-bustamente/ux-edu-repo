...
export const RECOMMENDATIONS_EVA: RecommendationEntry[] = [
  {
    ...
    recommendation: {
      ...
      why:
        "For example, research shows designing complex and open-ended tasks allows students to come up with their own ideas and make choices about their paths of action"
    },
    sources: [
      {
        title: "Implementing Authentic Tasks in Web-Based Learning Environments",
        authors: "Younghee Woo, Shirley Agostinho and Tom Reeves",
        venue: "EDUCAUSE REVIEW",
        quote:
          "designing complex and open-ended tasks allows students to come up with their own ideas and make choices about their paths of action",
    ...
    sources: [
      {
        ...
        url: "https://www.researchgate.net/publication/356610738_Student_Satisfaction_in_Using_a_Learning_Management_System_LMS_for_Blended_Learning_Courses_for_Tertiary_Education",
        doi: ""
      }
    ]
  },
  ...
  },
  {
    ...
    recommendation: {
      ...
      how:
        "Design the LMS course as a sequence of smaller, clearly structured assignments instead of one big project. Give each assignment explicit instructions, a rubric and a due date, link it to specific learning outcomes and gradebook items, and use milestones (proposal, draft, peer feedback, final submission) so students see a clear path through the course.",
      why:
       "In online and distance education, structured assignments with deadlines and evaluation provide discipline, progression and personalised guidance, helping learners manage time, stay engaged and build skills step by step.",
    },
    sources: [
      {
        title:
        ...
        venue: "ACM Inroads",
        quote:
          'Structured assignments with deadlines and evaluation provide discipline, progression, and personalized guidance',
        tags: ["LMS", "structured assignments", "scaffolding"],
        url: "https://www.researchgate.net/publication/241770573_What's_the_value_proposition_of_distance_education",
        doi: ""
      }
    ]
  },
  ...
  {
    inputID: "evaType-lms-inst-objects-modular-content",
    status: "needs-review",
    patternRef: "inst-scorm-objects",
    evaType: "lms",
    recommendation: {
      title: "Integrate compliant content in LMS courses",
      how:
        "Configure the LMS so that its authoring tools and rich-text editors have built-in accessibility checkers aligned with ATAG and WCAG 2.1/2.2. Make it a standard that every uploaded resource (HTML pages, documents, images, quizzes) passes this checker: correct heading hierarchy, alternative text for images, adequate contrast, keyboard navigation, and warnings when accessibility information is missing. Provide accessible templates and contextual hints that prompt teachers to fill in required information (for example, descriptions for charts and tables) before publishing content.",
      why:
        "LMS platforms must not only be accessible for learners and instructors but also help them produce accessible content. W3C WAI and ATAG guidelines emphasize that authoring tools should support instructors in creating materials that conform to WCAG and that accessibility is both a legal obligation and a matter of equity. Integrating compliant content directly into the LMS authoring workflow reduces technical debt, prevents accessibility incidents, and improves the experience for all users.",
    },
    sources: [
      {
        title: "W3C WAI. (2022). Standards to Make Your LMS Accessible.",
        authors: "W3C WAI. (2022)",
        venue: "W3C",
        quote:
          "LMSs need to produce accessible content. Part of that is up to your tool and part is up to the user.",
        tags: ["LMS", "accessible-authoring", "WCAG"],
        url: "https://www.w3.org/WAI/standards-guidelines/atag/education/",
        doi: ""
      }
    ]
  },
  {
    ...
    sources: [
      {
        title: "Effective Integration of Wiki for Collaborative Learning in Higher Education Context",
        authors: "Farrah Dina Yusop and Siti Mariam Muhammad Abdul Basar",
        venue: "ResearchGate",
        quote:
          "students had positive perceptions towards the use of wiki in their collaborative writing exercises.",
        tags: ["wiki", "collaborative learning", "community"],
        url: "https://www.researchgate.net/publication/289267703_Effective_integration_of_wiki_for_collaborative_learning_in_higher_education_context",
        doi: ""
      }
    ]
  },
  ...
  },
  {
    ...
    recommendation: {
      ...
      why:
        'To engage and motivate learners, the use of gamification techniques can contribute a lot to how students can learn better.'
    },
    sources: [
      {
        title: "Effectiveness of Gamification in a VLE to Improve User Engagement and Motivation",
        authors: "Taalia Nadeem",
        venue: "Bourmemouth University",
        quote:
          "To engage and motivate learners, the use of gamification techniques can contribute a lot to how students can learn better.",
        tags: ["gamification", "motivation", "engagement"],
        url: "https://www.researchgate.net/publication/347441035_Effectiveness_of_Gamification_in_a_VLE_to_Improve_User_Engagement_and_Motivation",
        doi: ""
      }
    ]
  },
  ...
  // ---------- MOOC ----------
  {
    ...
    recommendation: {
      ...
      why:
        "For example, researches show that designing complex and open-ended tasks allows students to come up with their own ideas and make choices about their paths of action."
    },
    sources: [
      {
        title: "Implementing Authentic Tasks in Web-Based Learning Environments",
  ...
  },
  {
    ...
    recommendation: {
      ...
      how:
        "Organise the MOOC into weekly modules, each with a small, structured assignment (quiz, problem set, short reflection, or mini-project). Keep the pattern consistent week by week (e.g., video → readings → practice quiz → graded assignment), clearly stating expected effort, deadlines, and grading. Align every assignment explicitly with the week’s intended learning outcomes and provide automatic or peer-based feedback where possible.",
      why:
        "MOOC research shows that intentional course structure and the balance and sequencing of activities and assessments strongly shape learner engagement, completion and assessment pass rates, and that weekly assignments in instructor-paced courses act as anchors that support regular participation and more total learning."
    },
    sources: [
      {
        title:
        ...
        authors:
          "John, H., Kerr, J., & Andrieux, G.",
        venue: "Journal of Interactive Media in Education",
        quote:
          "Frequency and sequencing of learning types create opportunities for learners to engage with content in a meaningful way.",
        tags: ["MOOC", "weekly structure", "assessment"],
        url: "https://jime.open.ac.uk/articles/10.5334/jime.890",
        doi: ""
      }
    ]
  },
  ...
  {
    inputID: "evaType-mooc-inst-objects-modular-content",
    status: "needs-review",
    patternRef: "inst-scorm-objects",
    evaType: "mooc",
    recommendation: {
      title: "Integrate compliant content in MOOCs",
      how:
        "When designing the MOOC, require that all resources (pages, videos, quizzes, PDFs) comply at least with WCAG 2.1 AA. Use a clear heading structure, meaningful alternative text for images, sufficient color contrast, full keyboard operability, properly labeled form fields, and accessible video player controls. Support this with automated accessibility checks (e.g., WAVE, axe, AChecker) and an expert review before publishing each module.",
      why:
        'Studies show that a significant proportion of MOOC learners are people with disabilities or older adults. Systematic application of WCAG in course content positively impacts their motivation and reduces access barriers. Evaluations of major MOOC platforms have found that many issues come from course materials without alt text, poorly structured headings, or controls that are not operable with screen readers, so integrating compliant content from the start is crucial for inclusion and legal compliance.'
    },
    sources: [
      {
        ...
        venue: "SpringerLink",
        quote:
          "Taking into consideration the variety of MOOC users, it is very important to ensure high level of the accessibility of MOOC platforms.",
        tags: ["MOOC", "accessibility", "WCAG"],
        url: "https://link.springer.com/article/10.1007/s10209-022-00927-2",
        doi: ""
      }
    ]
  },
    ...
    sources: [
      {
        ...
        authors: "Kenneth Orenic; Molly Beestrum",
        venue: "College of DuPage Library Publications",
        quote:
          "Wikis have added a new dimension to the process of collaborative learning",
        tags: ["wiki", "collaborative learning", "community"],
        url: "https://dc.cod.edu/librarypub/20/",
        doi: ""
      }
    ]
  },
  ...
  },
  {
    ...
    recommendation: {
      ...
      how:
        "For each virtual class, define a simple assignment structure: a short pre-class prep task in the LMS, at least one structured collaborative assignment during the live session (for example, a problem to solve in breakout rooms with a shared template), and a brief post-class consolidation task with clear criteria and deadlines.",
      why:
        "Evidence reviews on virtual classrooms highlight that clear objectives, scaffolding or mastery learning, practice opportunities and test-enhanced learning are key drivers of effectiveness; structured assignments before, during and after live sessions create spaced practice and consolidation that improve learning outcomes."
    },
    sources: [
      {
        title:
        ...
        authors:
          "Young, J., Gifford, J., & Lancaster, A",
        venue: "Chartered Institute of Personnel and Development (CIPD)",
        quote:
          "A successful virtual classroom will set up an accountability framework with clear milestones using various tools to measure progress.",
        tags: ["virtual classroom", "structured tasks", "engagement"],
        url: "https://www.cipd.org/globalassets/media/knowledge/knowledge-hub/evidence-reviews/effective-virtual-classrooms-practice-summary_tcm18-102661.pdf",
        doi: ""
      }
    ]
  },
  ...
  {
    inputID: "evaType-virtual-classroom-inst-objects-modular-content",
    status: "needs-review",
    patternRef: "inst-scorm-objects",
    evaType: "virtual-classroom",
    recommendation: {
      title:
        "Integrate compliant content in Virtual classrooms",
      how:
        "For synchronous sessions and their recordings, always enable live captions and generate editable transcripts. Ensure that slides and shared materials follow WCAG criteria (contrast, font size, linear reading order, verbal descriptions of charts and images), and that links to external resources point to accessible versions (tagged documents, structured PDFs, WCAG-compliant pages). Upload the recordings back into the course platform with finalized captions and transcripts.",
      why:
        "Video is a core element of the virtual classroom and, if it is not accessible (no captions, no transcript), it limits access for deaf and hard-of-hearing students or those who cannot keep up in real time. Research in online education and legal guidelines (such as ADA and Section 508) indicate that accessibility of videos and virtual classes—especially through captions and transcripts—is both a legal requirement and a best practice that improves access and learning for all students, not only those with formal accommodations.",
    },
    sources: [
      {
        title: "Creating Accessible Videos: Captions and Transcripts",
        authors: "Liz McCarron ",
        venue: "Bentley University",
        quote:
          "…helps ensure that all students have equal access to the information they contain.",
        tags: ["virtual-classroom", "video-accessibility", "captions"],
        url: "https://aisel.aisnet.org/cgi/viewcontent.cgi?article=4275&context=cais",
        doi: ""
      }
    ]
  },
...
.`,
  ...
  },
  {
    ...
    recommendation: {
      ...
      how: `Equip young learners with age-appropriate educational tools (for example, calculators, digital manipulatives, simulations, and other educational apps inside the LMS). Introduce each tool gradually in context: explain what it is for, model how to use it to solve a problem or visualize an idea, and give students a short guided practice activity before expecting them to use it independently.`,
      why: `In K–12 online and blended learning, the quality and clarity of the tools provided strongly influence student engagement and performance. Interactive and multimedia tools, when clearly integrated into class activities, help students access information more easily, stay motivated, and practice key skills in a more active way, instead of just reading or watching passively.`
    },
  ...
  },
  {
    ...
    recommendation: {
      ...
      how: `Begin the online class with a clear, kid-friendly course overview. Use a simple 'Start here' or 'Welcome' page (and optionally a short video) that explains, in plain language, what students will learn, how the weeks are organized, what a “typical week” looks like, and where to find homework and grades. Include a short note for parents or guardians about how to navigate the class, where to see updates, and how to contact the teacher so everyone knows what to expect.`,
      why: `K–12 learners and their families rely on predictable routines and clear expectations. A well-organized course introduction reduces confusion and anxiety, helps students feel prepared to participate, and gives parents enough information to support their children. Providing this structure and a welcoming tone at the start of the course also contributes to a stronger sense of community and better engagement over time.`
    },
    sources: [
      {
    ...
    sources: [
      {
        ...
        venue: "Nielsen Norman Group",
        quote: `consider shortening the breadcrumb trail if your users’ tasks allow it`,
...
.`,
  ...
  },
  {
    ...
    recomendation: {
      ...
      why: `Users sometimes say that they’d rather go to a desktop site than to a mobile site. That’s mostly due to their prior experience with mobile-optimized content`,
    },
    sources: [
      {
        ...
        authors: "Raluca Budiu",
        venue: "Nielsen Norman Group",
        quote: `Users sometimes say that they’d rather go to a desktop site than to a mobile site. That’s mostly due to their prior experience with mobile-optimized content.`,
...
.`,
  ...
  },
  {
    ...
    recomendation: {
      ...
      how: `On mobile, provide a single reverse-chronological activity feed that aggregates key learning events across the virtual learning environment (new announcements, published resources, forum replies, new grades, and upcoming deadlines). Show the most recent items at the top, grouped by date labels (e.g., Today, Yesterday, This week) and clearly indicate the course and activity type with concise icons and labels. Make every item tappable so learners can jump directly to the relevant assignment, discussion, or resource. Offer simple filters (by course or event type) to reduce noise and allow learners to mark items as read or done so the feed stays focused on what still needs attention.`,
      why: `Mobile learners usually connect in short sessions and need a quick answer to the question ‘What has changed since last time?’. A chronological activity feed surfaces the most recent learning events and assessment deadlines in one place, reducing the need to open multiple course sections. Research on learning analytics dashboards shows that many effective dashboards provide status updates on progression through course materials and alerts of upcoming assessment submission deadlines to support student planning and time management in online courses. By turning these events into a mobile-friendly activity stream, you provide actionable, just-in-time insights that help learners adjust their study habits and better self-regulate their learning.`,
    },
    sources: [
      {
        title: "Learning analytics dashboard: a tool for providing actionable insights to learners",
        authors: "Susnjak, T., Ramaswami, G. S., & Mathrani, A.",
        venue: "International Journal of Educational Technology in Higher Education",
        quote: `Other studies also assisted learners in planning and provided alerts of upcoming assessment submission deadlines.`,
        tags: ["activity stream", "feed", "notifications"],
...
export const PLATFORM_WEB_RESPONSIVE_UI_RECOMMENDATIONS = [
  {
    ...
    sources: [
      ...
      venue: "Nielsen Norman Group",
      quote:
        "Ideally, all validation should be inline; when users finish a field, show an indicator nearby if it contains an error.",
      tags: ["forms", "inline-validation", "errors"],
      url: "https://www.nngroup.com/articles/errors-forms-design-guidelines/"
    }
