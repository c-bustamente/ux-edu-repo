...
export function MainPage({ onSectionChange }: MainPageProps) {
  const features = [
    {
      id: 'principles',
      icon: BookOpen,
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Your comprehensive platform for learning and mastering user experience design for educational pourposes. 
          Explore principles, patterns, and best practices that will elevate your design skills.
        </p>
        <div className="flex gap-4 justify-center">
          <Button size="lg" onClick={() => onSectionChange('principles')}>
            <Lightbulb className="mr-2 h-5 w-5" />
            Start Learning
          </Button>
          <Button variant="outline" size="lg" onClick={() => onSectionChange('community')}>
